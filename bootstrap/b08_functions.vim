" Functions {
  ...
  function! s:IsinvimplugFork()
    let s:is_fork = 0
    let s:fork_files = ["~/.vim/bootstrap/vimrc.fork.vim", "~/.vim/bootstrap/vimrc.before.fork.vim", "~/.vim/bootstrap/vimrc.bundles.fork".vim]
  ...
  function! s:EditinvimplugConfig()
    ...
    call <SID>ExpandFilenameAndExecute("vsplit", "~/.vim/bootstrap/vimrc.before.vim")
    call <SID>ExpandFilenameAndExecute("vsplit", "~/.vim/bootstrap/vimrc.bundles.vim")
    ...
    if <SID>IsinvimplugFork()
      execute bufwinnr(".vimrc") . "wincmd w"
      call <SID>ExpandFilenameAndExecute("split", "~/.vim/bootstrap/vimrc.fork.vim")
      wincmd l
      call <SID>ExpandFilenameAndExecute("split", "~/.vim/bootstrap/vimrc.before.fork.vim")
      wincmd l
      call <SID>ExpandFilenameAndExecute("split", "~/.vim/bootstrap/vimrc.bundles.fork.vim")
    endif
